...
\item Les \textbf{Server Actions} sont privilégiées par rapport aux routes API, à l'exception
      de l'endpoint de vérification du Bon de Sortie, qui doit rester accessible via une route
      API classique pour être appelable par le scanner.
